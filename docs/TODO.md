...
| jsonl-domain-storage | in-progress | ✓ | ✓ | ✓ | needs_work | 2026-07-10 |  | JSONL storage/migration/query implemented; HLD eval dry-run needs live retrieval baseline before acceptance |
