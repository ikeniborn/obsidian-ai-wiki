...
| jsonl-domain-storage | in-progress | ✓ | ✓ | ✓ | – | 2026-07-10 |  | Self-contained metadata.jsonl; per-domain index/log JSONL; verified backup migration; HLD eval pending implementation |
