...
| td1-td2-evidence-and-grounding | in-progress | n/a | ✓ | ✓ | – | 2026-07-27 |  | TD-1 exact evidence reconciliation + TD-2 query context/grounding; Phase 0 red tests, live os-unix run, diagnostic os-mac pass. Spec OK on 2026-07-28: all four phases passed, 30 findings fixed and 1 wontfix, none open. TD-2 now carries four classes (§2.4 title-only support added for the `linux-cache-sysctl` group). Plan OK on 2026-07-29: all five phases passed, 2 warnings open (Task 3 step mis-reference, Task 10 TD-1 file-attribution wording) |
