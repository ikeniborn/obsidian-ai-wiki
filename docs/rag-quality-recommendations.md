...
- HLD harness compares `weighted-lexical`, raw BM25 page/chunk, RRF BM25 variants, and eval-only controlled boilerplate demotion factors `0.15`, `0.25`, `0.35`, `0.50`. Current HLD run: 61 pages, 442 chunks, average improved `Overlap@5 = 0.68` against target `0.65`. Gold verdict `accepted`: best variant `weighted-lexical-demoted` with factor `0.15` (`Recall@5 = 0.76`, `nDCG@5 = 0.92`, `MRR = 1.00`). Raw BM25/RRF did not beat weighted lexical; demotion gave a small nDCG gain without Recall/MRR regression. Candidate runtime setting, if implemented later: boilerplate demotion factor `0.15`; stronger factors reduce legacy overlap and fail guards.
