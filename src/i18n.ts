...
const en = {
  ...
  settings: {
    ...
    autoBudgetNotice_body: "Native input and output budgets are now derived automatically from the model's context window. You have a stored budget override from before this change. Switch to automatic, or keep your stored values? The Input budget tokens and Output budget tokens fields in Settings stay visible either way and show \"Automatic\" until you type a number.",
...
const es: I18n = {
  ...
  settings: {
    ...
    repairInputBudgetTokens_desc: "Presupuesto máximo de entrada para reintentos de reparación estructurada. Por defecto 65536. Se usa cuando una solicitud válida requiere un prompt de reparación mayor.",
    ...
    autoBudgetNotice_body: "Los presupuestos nativos de entrada y salida ahora se derivan automáticamente de la ventana de contexto del modelo. Tiene guardada una anulación de presupuesto de antes de este cambio. ¿Cambiar a automático o conservar sus valores guardados? Los campos Input budget tokens y Output budget tokens en Ajustes siguen visibles en cualquier caso y muestran \"Automático\" hasta que escriba un número.",
