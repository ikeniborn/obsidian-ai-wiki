...
const es: I18n = {
  settings: {
    ...
    bfsMinScoreRatio_desc: "Descartar páginas expandidas por el grafo cuyo coseno denso esté por debajo de esta fracción del coseno del mejor seed. 0 = off. Solo para recuperación densa (embedding/híbrida).",
