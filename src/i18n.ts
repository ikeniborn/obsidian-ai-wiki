...
const en = {
  ...
  settings: {
    ...
    maxTokens_desc: "Response/output cap. Default 4096. ↑ longer answers, slower/costlier · ↓ risk of truncation. Recommended ≥ 4096.",
...
const ru: I18n = {
  ...
  settings: {
    ...
    maxTokens_desc: "Лимит ответа/вывода. По умолч. 4096. ↑ длиннее ответ, медленнее/дороже · ↓ риск обрыва. Рекомендую ≥ 4096.",
...
const es: I18n = {
  ...
  settings: {
    ...
    maxTokens_desc: "Límite de respuesta/salida. Por defecto 4096. ↑ respuestas más largas, más lento/caro · ↓ riesgo de truncado. Recomendado ≥ 4096.",
    ...
    outputBudgetTokens_desc: "Límite de respuesta/salida guardado en el campo maxTokens existente. Solo se guardan enteros positivos finitos.",
