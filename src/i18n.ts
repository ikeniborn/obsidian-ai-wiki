...
const ru: I18n = {
  ...
  settings: {
    ...
    contextWindowTokens_desc: "Сколько токенов модель вмещает в один запрос. Пусто — автоматически: окно читается у бэкенда. Задавайте значение, только если бэкенд его не сообщает: признаки — запасное окно 8192 в agent-логе, выброшенные блоки схемы и запросы, обрезанные лимитом в 4096 токенов. Тогда все бюджеты выводятся из вашего числа. Минимум — 1024 токена, меньшие значения не принимаются. Применяется ко всем нативным моделям.",
