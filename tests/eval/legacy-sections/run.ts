 ...
 *   node_modules/.bin/esbuild tests/eval/legacy-sections/run.ts \
 *     --bundle --platform=node --format=cjs \
 *     --alias:obsidian=./tests/eval/legacy-sections/obsidian-stub.ts \
 *     --outfile=tests/eval/legacy-sections/run.cjs
 *   node tests/eval/legacy-sections/run.cjs
 *
...
// ---------- tiny assert framework (mirrors tests/eval/format-frontmatter/run.ts) ----------
let pass = 0;
let fail = 0;
