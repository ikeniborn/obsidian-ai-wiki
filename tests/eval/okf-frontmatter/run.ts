...
//   node_modules/.bin/esbuild tests/eval/okf-frontmatter/run.ts \
//     --bundle --platform=node --format=cjs \
//     --alias:obsidian=./tests/eval/okf-frontmatter/obsidian-stub.ts \
//     --outfile=tests/eval/okf-frontmatter/run.cjs
//   node tests/eval/okf-frontmatter/run.cjs
