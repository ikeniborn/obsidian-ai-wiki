// Pure sweep/summary over captured graph-candidate cosines (tests/eval/graph-floor/capture.json,
...
// Printable entry: `npx tsx tests/eval/graph-floor/analyze.ts [capture.json]`
