 ...
 * Run: WIKI_VAULT=… EMBED_BASE_URL=… EMBED_MODEL=… EMBED_DIM=… EMBED_API_KEY=… npx tsx tests/eval/graph-floor/run.ts
 */
import "./register";
...
void (async () => {
  ...
  console.log(`\nWrote ${out.length} records to tests/eval/graph-floor/capture.json`);
})();
