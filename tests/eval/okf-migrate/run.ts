 ...
 *
 * `npx tsx tests/eval/okf-migrate/run.ts` may fail if tsx tries to resolve the `obsidian` module
 ...
 *   node_modules/.bin/esbuild tests/eval/okf-migrate/run.ts \
 *     --bundle --platform=node --format=cjs \
 *     --alias:obsidian=./tests/eval/okf-migrate/obsidian-stub.ts \
 *     --outfile=tests/eval/okf-migrate/run.cjs
 *   node tests/eval/okf-migrate/run.cjs
 */
