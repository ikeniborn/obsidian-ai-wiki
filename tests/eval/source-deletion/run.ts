 ...
 *   node_modules/.bin/esbuild tests/eval/source-deletion/run.ts \
 *     --bundle --platform=node --format=cjs \
 *     --alias:obsidian=./tests/eval/source-deletion/obsidian-stub.ts \
 *     --outfile=tests/eval/source-deletion/run.cjs
 *   node tests/eval/source-deletion/run.cjs
 */
